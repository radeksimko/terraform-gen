...
type HelperGenerator struct {
	InlineFieldFilterFunc  fieldFilterFunc
	OutlineFieldFilterFunc fieldFilterFunc
	InputVarName           string
...
func (hg *HelperGenerator) init() {
	...
	if hg.InlineFieldFilterFunc == nil {
		hg.InlineFieldFilterFunc = acceptAllFilter
	}
	if hg.OutlineFieldFilterFunc == nil {
		hg.OutlineFieldFilterFunc = rejectAllFilter
	}
	if hg.mapVarName == "" {
...
func acceptAllFilter(iface interface{}, sf *reflect.StructField, k reflect.Kind, s *schema.Schema) (reflect.Kind, bool) {
	return k, true
}

func rejectAllFilter(iface interface{}, sf *reflect.StructField, k reflect.Kind, s *schema.Schema) (reflect.Kind, bool) {
	return k, false
}
